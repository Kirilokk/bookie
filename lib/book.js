...
export async function insertBook(bookData) {
  ...
  try {
    ...
    const result = await client.query(
      `INSERT INTO books (title, author_id, publisher_id, page_count, status, cover_color, image_url, api_book_id)
    VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
    RETURNING *`, [bookData.title, authorId, publisherId, bookData.page_count, bookData.status, bookData.coverColor, bookData.image, bookData.api_book_id]);
